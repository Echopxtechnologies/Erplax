<x-layouts.app>
    <x-slot name="header">
        <h1 class="page-title">Create Attendance Record</h1>
        <p style="color: var(--text-secondary); font-size: var(--font-sm); margin: 4px 0 0;">Add a new attendance entry</p>
    </x-slot>
    ...
    <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('admin.attendance.store') }}" style="display: flex; flex-direction: column; gap: 16px;">
            @csrf
            <div class="card">
                ...
                <div style="padding: 24px;">
                    <div style="display: grid; gap: 20px;">
                        ...
                        <div>
                            ...
                            <input type="date" name="attendance_date" class="form-control" value="{{ old('attendance_date', date('Y-m-d')) }}" required style="padding: 10px; border: 1px solid var(--input-border); border-radius: 6px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                            <div>
                                ...
                                <input type="datetime-local" name="check_in_time" class="form-control" value="{{ old('check_in_time') }}" style="padding: 10px; border: 1px solid var(--input-border); border-radius: 6px;">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="check_out_time" class="form-control" value="{{ old('check_out_time') }}" style="padding: 10px; border: 1px solid var(--input-border); border-radius: 6px;">
                        ...
                        <div>
                            ...
                            <textarea name="notes" class="form-control" rows="4" placeholder="Add any notes or remarks..." style="padding: 10px; border: 1px solid var(--input-border); border-radius: 6px; resize: vertical;">{{ old('notes') }}</textarea>
