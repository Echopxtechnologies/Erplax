...
<div class="wo-container">
    ...
    <div class="wo-filters">
        <form method="GET" action="{{ route('admin.website.orders') }}">
            ...
            @if(request()->hasAny(['search', 'status', 'payment_status']))
                <a href="{{ route('admin.website.orders') }}" class="wo-btn wo-btn-secondary">Reset</a>
            @endif
        </form>
    </div>
    ...
    <div class="wo-table-wrap">
        ...
        <table class="wo-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="{{ route('admin.website.orders.show', $order->id) }}" class="wo-link">{{ $order->order_no }}</a>
                    </td>
                    <td>
                    ...
                    <td class="wo-date">{{ $order->created_at->format('d M Y, h:i A') }}</td>
                    <td>
                        <a href="{{ route('admin.website.orders.show', $order->id) }}" class="wo-btn wo-btn-secondary" style="padding: 6px 12px; font-size: 13px;">View</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
