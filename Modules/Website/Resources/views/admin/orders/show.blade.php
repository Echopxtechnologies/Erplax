...
<div class="order-container">
    ...
    <div class="order-header">
        <div class="order-title">
            <a href="{{ route('admin.website.orders') }}" class="back-btn">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.website.orders.invoice', $order->id) }}" target="_blank" class="btn btn-outline">
    ...
    <div class="order-grid">
        ...
        <div class="order-main">
            ...
            <div class="quick-actions">
                ...
                <form action="{{ route('admin.website.orders.status', $order->id) }}" method="POST" style="flex:1; min-width: 120px;">
                    @csrf
                ...
                <form action="{{ route('admin.website.orders.status', $order->id) }}" method="POST" style="flex:1; min-width: 120px;" onsubmit="return confirm('Are you sure you want to cancel this order? Stock will be restored.')">
                    @csrf
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item {{ $loop->first ? 'current' : 'active' }}">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-meta">{{ $history->created_at->format('d M Y, h:i A') }}</div>
                                @if($history->comment)
        ...
        <div class="order-sidebar">
            ...
            <div class="card" id="payment-section">
                ...
                <div class="card-body">
                    ...
                    <div class="action-card" style="margin-top: 16px;">
                        ...
                        <form action="{{ route('admin.website.orders.payment', $order->id) }}" method="POST">
                            @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.website.orders.status', $order->id) }}" method="POST">
                        @csrf
                        <div class="form-group">
...
<div id="shipping-modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); z-index:1000; align-items:center; justify-content:center;">
    <div style="background:#fff; border-radius:12px; padding:24px; max-width:400px; width:90%; max-height:90vh; overflow-y:auto;">
        ...
        <form action="{{ route('admin.website.orders.shipping', $order->id) }}" method="POST">
            @csrf
            <div class="form-group">
...
<div id="delivery-modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); z-index:1000; align-items:center; justify-content:center;">
    <div style="background:#fff; border-radius:12px; padding:24px; max-width:400px; width:90%; max-height:90vh; overflow-y:auto;">
        ...
        <form action="{{ route('admin.website.orders.confirm-delivery', $order->id) }}" method="POST">
            @csrf
