...
<div class="ws-dashboard">
    ...
    <div class="ws-header">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.website.settings') }}" class="btn-secondary">
    ...
    <div class="alert-card warning">
        ...
        <a href="{{ route('admin.website.reviews') }}" class="alert-action">Review Now</a>
    </div>
    @endif
    ...
    <div class="dashboard-grid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.website.orders') }}" class="card-action">View All →</a>
            </div>
            <table class="orders-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="{{ route('admin.website.orders.show', $order->id) }}" class="order-id">{{ $order->order_no }}</a></td>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="quick-actions">
                    <a href="{{ route('admin.website.settings') }}" class="quick-action">
                    ...
                    <a href="{{ route('admin.website.orders') }}" class="quick-action">
                    ...
                    <a href="{{ route('admin.website.reviews') }}" class="quick-action">
