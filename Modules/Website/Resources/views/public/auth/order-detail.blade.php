...
<div class="order-detail-page">
    <div class="order-header">
        <div class="header-left">
            <a href="{{ route('website.orders') }}" class="back-link">
            ...
            <p class="order-date">Placed on {{ $order->created_at->format('d M Y, h:i A') }}</p>
        </div>
    ...
    <div class="order-content">
        ...
        <div class="order-actions">
            <a href="{{ route('website.shop') }}" class="btn-continue">Continue Shopping</a>
            @if($order->canBeCancelled())
            <form action="{{ route('website.order.cancel', $order->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to cancel this order?')">
                @csrf
