        ...
        @elseif(count($cartItems) > 0)
            <div class="cart-layout">
                <div class="cart-items">
                    @foreach($cartItems as $item)
                        <div class="cart-item" wire:key="cart-{{ $item['key'] }}">
                            ...
                            <div class="item-info">
                                <a href="{{ route('website.product', $item['product_id']) }}" class="item-name">{{ $item['name'] }}</a>
                ...
                <div class="cart-summary">
                    ...
                    @endif
                    <a href="{{ route('website.checkout') }}" class="checkout-btn">Proceed to Checkout</a>
                    <a href="{{ route('website.shop') }}" class="continue-link">← Continue Shopping</a>
                </div>
            </div>
        @else
            <div class="empty-cart">
                ...
                <a href="{{ route('website.shop') }}" class="shop-btn">Start Shopping</a>
            </div>
        @endif
    </div>
</div>
