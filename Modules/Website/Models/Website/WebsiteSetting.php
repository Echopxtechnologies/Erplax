...
namespace Modules\Website\Models\Website;
...
class WebsiteSetting extends Model
{
    ...
    public function generateOrderNumber(): string
    {
        ...
        $lastOrder = \Modules\Website\Models\Ecommerce\WebsiteOrder::orderBy('id', 'desc')->first();
    ...
    public function generateInvoiceNumber(): string
    {
        ...
        $year = date('Y');
        $lastOrder = \Modules\Website\Models\Ecommerce\WebsiteOrder::whereYear('created_at', $year)
