...
class WebsiteAuthController extends WebsiteController
{
    /**
     * Show login page
     */
    public function showLogin(Request $request)
    {
        ...
        return view('website::public.auth.login', compact('settings'));
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['email' => $email, 'password' => $request->password], $request->boolean('remember'))) {
            ...
            return redirect()->route('website.account')->with('success', 'Welcome back!');
        }
    ...
    public function showRegister(Request $request)
    {
        ...
        $settings = WebsiteSetting::instance();
        return view('website::public.auth.register', compact('settings'));
    }
    ...
    public function register(Request $request)
    {
        ...
        return redirect()->route('website.account')->with('success', 'Account created!');
    }
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('website.shop')->with('success', 'Logged out.');
    }
    ...
    public function account()
    {
        ...
        return view('website::public.auth.account', compact('settings', 'user', 'customer'));
    }
    ...
    public function myOrders(Request $request)
    {
        ...
        $orders = \Modules\Website\Models\Ecommerce\WebsiteOrder::where('user_id', Auth::id())
            ->orderBy('created_at', 'desc')
            ->paginate(10);
        
        return view('website::public.auth.orders', compact('settings', 'user', 'orders'));
    }
    ...
    public function orderDetail($id)
    {
        ...
        $order = \Modules\Website\Models\Ecommerce\WebsiteOrder::where('id', $id)
        ...
        return view('website::public.auth.order-detail', compact('settings', 'user', 'order', 'invoice'));
    }
