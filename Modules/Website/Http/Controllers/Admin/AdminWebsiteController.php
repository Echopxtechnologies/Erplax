...
use Modules\Website\Models\Ecommerce\ProductReview;
...
class AdminWebsiteController extends AdminController
{
    ...
    public function index()
    {
        ...
        return view('website::admin.index', compact(
    ...
    public function settings()
    {
        ...
        return view('website::admin.settings', compact('settings', 'modes'));
    }
    ...
    public function updateSettings(Request $request)
    {
        $validated = $request->validate([
            ...
            'site_prefix' => 'nullable|string|max:50|regex:/^[a-zA-Z0-9\-_]+$/',
            'shop_prefix' => 'nullable|string|max:50|regex:/^[a-zA-Z0-9\-_]+$/',
            'site_mode' => 'required|in:website_only,ecommerce_only,both',
            ...
            'site_favicon' => 'nullable|image|mimes:ico,png,jpg,gif,svg|max:512',
        ...
        if ($request->hasFile('site_favicon')) {
            ...
            $validated['site_favicon'] = $request->file('site_favicon')->store('website', 'public');
        }
        ...
        if (!$request->hasFile('site_favicon')) unset($validated['site_favicon']);

        $settings->update($validated);

        return redirect()->route('admin.website.settings')->with('success', 'Settings updated successfully!');
    }
