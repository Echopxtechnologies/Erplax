...
<div class="auth-page">
    <div class="auth-container">
        <a href="{{ route('ecommerce.shop') }}" class="back-link">
        ...
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('ecommerce.register.post') }}">
                @csrf
            ...
            <p class="auth-footer">Already have an account? <a href="{{ route('ecommerce.login') }}">Login</a></p>
        </div>
    </div>
</div>
@endsection
