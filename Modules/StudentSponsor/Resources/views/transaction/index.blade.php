...
<div style="padding: 20px;">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.studentsponsor.payment.index') }}" class="btn-secondary">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                </svg>
                View Payments
            </a>
            <a href="{{ route('admin.studentsponsor.transaction.create') }}" class="btn-add">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="table-card">
        ...
        <div class="table-card-body">
            <table class="dt-table dt-search dt-export dt-perpage" 
                   data-route="{{ route('admin.studentsponsor.transaction.data') }}">
                <thead>
                    <tr>
                        ...
                        <th class="dt-sort" data-col="total_amount">Total</th>
                        <th data-col="amount_paid">Paid</th>
                        <th data-col="balance">Balance</th>
                        <th data-col="payment_type" data-render="badge">Frequency</th>
                        <th class="dt-sort" data-col="next_payment_due">Next Due</th>
