<style>
    ...
    .student-avatar { width: 40px; height: 40px; border-radius: 50%; object-fit: cover; background: var(--body-bg); border: 2px solid var(--card-border); flex-shrink: 0; }
...
<div style="padding: 20px;">
    ...
    <div class="stats-grid">
        <div class="stat-card active" data-filter="all" onclick="filterByStatus('')">
            ...
            <div class="stat-content"><div class="stat-value">{{ $stats['total'] }}</div><div class="stat-label">Total Students</div></div>
        </div>
        <div class="stat-card" data-filter="1" onclick="filterByStatus('1')">
            ...
            <div class="stat-content"><div class="stat-value">{{ $stats['active'] }}</div><div class="stat-label">Active</div></div>
        </div>
        <div class="stat-card" data-filter="0" onclick="filterByStatus('0')">
            ...
            <div class="stat-content"><div class="stat-value">{{ $stats['inactive'] }}</div><div class="stat-label">Inactive</div></div>
        </div>
    </div>
    ...
    <div class="table-card">
        ...
        <div class="table-card-body">
            ...
            <table id="studentsTable" 
                ...
                <thead>
                    <tr>
                        <th class="dt-sort" data-col="id" style="width:60px;">ID</th>
...
<script>
    ...
    window.dtRenders.student_cell = function(value, row) {
        var avatar = row.profile_photo_url || '{{ asset("images/default-avatar.png") }}';
        return '<div class="student-cell">' +
            '<img src="' + avatar + '" alt="" class="student-avatar" onerror="this.src=\'{{ asset("images/default-avatar.png") }}\'">' +
