    ...
    */
    ...
    public static function config(): array
    {
        return [
            'name' => 'Purchase',
            'alias' => 'purchase',
            'description' => 'Purchase Management - Vendors, Purchase Orders, GRN, Bills',
            'version' => '1.0.0',
            'is_core' => true,
            'sort_order' => 60,
        ];
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'slug' => 'vendors',
                        'icon' => 'building',
                        'route' => 'admin.purchase.vendors.index',
                        'sort_order' => 1,
                        'actions' => ['read', 'create', 'edit', 'delete', 'export', 'import'],
                    ],
                    [
                        'menu_name' => 'Purchase Requests',
                    ...
                    [
                        ...
                        'sort_order' => 3,
                        'actions' => ['read', 'create', 'edit', 'delete', 'approve', 'print'],
                    ],
                    [
                    ...
                    [
                        'menu_name' => 'Purchase Settings',
                        'slug' => 'purchase-settings',
                        'icon' => 'settings',
                        'route' => 'admin.purchase.settings',
                        'sort_order' => 6,
                        'actions' => ['read', 'edit'],
                    ],
                ],
