    ...
    <x-slot name="header">
        <div style="display:flex;align-items:center;justify-content:space-between;">
            <h1 style="margin:0;font-size:20px;font-weight:600;color:var(--text-primary);">Add Customer Group</h1>
            ...
            <div class="ccard">
                <div class="ccard-b">
                    <div style="margin-bottom:16px;">
                        ...
                        <input type="text" name="name" class="finput" value="{{ old('name') }}" required autofocus>
                        @error('name')<div class="ferr">{{ $message }}</div>@enderror
                    </div>

                    <div>
                        <label class="flbl">Description</label>
                        <textarea name="description" class="finput" rows="4">{{ old('description') }}</textarea>
