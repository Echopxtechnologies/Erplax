...
<style>
    ...
    .code-preview { display: inline-flex; align-items: center; gap: 8px; padding: 8px 12px; background: #f5f3ff; border: 1px solid #ddd6fe; border-radius: 6px; margin-top: 8px; }
    .code-preview-label { font-size: 12px; color: #7c3aed; }
    .code-preview-value { font-size: 14px; font-weight: 600; color: #5b21b6; font-family: monospace; }
</style>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="code-preview">
                                <span class="code-preview-label">Full Code:</span>
