<x-layouts.app>
    <div style="max-width: 800px;">
        <h1 class="page-title" style="margin-bottom: 20px;">Create User</h1>
                        ...
                        <div>
                            ...
                            @else
                                <div style="padding: 24px; text-align: center; background-color: #f9fafb; border-radius: 6px;">
                                    <p style="margin: 0; color: #6b7280;">No roles available. <a href="{{ route('admin.settings.roles.create') }}" style="color: #4f46e5;">Create one first</a></p>
                                </div>
                            @endif
                        </div>
