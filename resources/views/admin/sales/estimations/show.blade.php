...
<style>
    ...
    .card-header h3 { font-size: 15px; font-weight: 700; color: var(--gray-800); margin: 0; }
    ...
    .amount-box { background: linear-gradient(135deg, #a78bfa, #c4b5fd); border-radius: 12px; padding: 20px; text-align: center; margin-bottom: 20px; }
    ...
    .tax-badge { display: inline-flex; padding: 3px 8px; background: #fef3f2; border: 1px solid #fecaca; border-radius: 4px; font-size: 10px; font-weight: 500; color: #991b1b; white-space: nowrap; }
    ...
    .tax-breakdown-title { font-size: 12px; font-weight: 700; color: var(--gray-600); text-transform: uppercase; margin-bottom: 8px; }
    ...
    .timeline-dot { position: absolute; left: -24px; top: 4px; width: 14px; height: 14px; border-radius: 50%; background: var(--gray-300); border: 3px solid white; box-shadow: 0 0 0 2px var(--gray-200); }
    ...
    .card-header h3 svg { width: 18px; height: 18px; color: var(--gray-500); }

    @media print { .header-actions, .btn { display: none !important; } .two-column { grid-template-columns: 1fr; } }
</style>
@endpush
...
<div class="page-wrapper">
    <div class="page-header">
        ...
        <div class="header-actions">
            ...
            <a href="{{ route('admin.sales.estimations.edit', $estimation->id) }}" class="btn btn-warning">Edit</a>
            <button onclick="window.print()" class="btn btn-secondary">Print</button>
            @if(!in_array($estimation->status, ['declined']))
    ...
    <div class="two-column">
                ...
                <div class="totals-section">
                    ...
                    <div class="tax-breakdown-section">
                        ...
                        <div class="tax-breakdown-item">
                            <span class="tax-name">{{ $key }}</span>
                            <span class="tax-amount">{{ $estimation->currency ?? 'INR' }} {{ number_format($tax['amount'], 2) }}</span>
                        </div>
                        @endforeach
                    </div>
                    @endif
        ...
        <div class="right-column">
            ...
            <div class="card">
                <div class="card-header"><h3>Estimation Details</h3></div>
                <div class="card-body">
                    <div class="info-grid">
            ...
            <div class="card">
                ...
                <div class="card-body" style="display: flex; flex-direction: column; gap: 10px;">
                    ...
                    @endif
                    @if($estimation->status === 'declined')<button type="button" class="btn btn-warning" onclick="updateStatus('draft')" style="width: 100%;">Revert to Draft</button>@endif
                ...
                <div class="card-body">
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="title">Estimation Revised</div>
                                <div class="meta">{{ $estimation->updated_at->format('d M Y, h:i A') }}</div>
                            </div>
                        </div>
                        @endif
