...
<div class="invoice-form-wrapper">
    ...
    <div class="invoice-header">
        ...
        <div class="header-buttons">
            <a href="{{ route('admin.sales.invoices.index') }}" class="btn btn-outline">Discard</a>
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-span-2">
                    ...
                    <input type="text" name="subject" class="form-control" value="{{ $invoice->subject ?? '' }}" required>
                </div>
                <div class="form-group">
            ...
            <div class="totals-wrapper">
                <div class="totals-box">
                    ...
                    <div class="totals-row">
                        ...
                        <input type="number" name="discount_percent" id="discountPercent" class="totals-input" value="{{ $invoice->discount_percent ?? 0 }}" step="0.01" min="0" max="100" onchange="calcTotals()" onkeyup="calcTotals()">
                    </div>
        ...
        <div id="tab-other" class="tab-content">
            <div class="form-row">
                ...
                <div class="form-group col-span-2">
                    ...
                    <textarea name="address" id="address" class="form-control" rows="2">{{ $invoice->address ?? '' }}</textarea>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">City</label>
                    <input type="text" name="city" id="city" class="form-control" value="{{ $invoice->city ?? '' }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="zip_code" id="zip_code" class="form-control" value="{{ $invoice->zip_code ?? '' }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Country</label>
                    <input type="text" name="country" id="country" class="form-control" value="{{ $invoice->country ?? '' }}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-span-2">
                    <label class="form-label">Customer Notes</label>
                    <textarea name="content" class="form-control" rows="3">{{ $invoice->content ?? '' }}</textarea>
                </div>
                <div class="form-group col-span-2">
                    <label class="form-label">Internal Notes</label>
                    <textarea name="admin_note" class="form-control" rows="3">{{ $invoice->admin_note ?? '' }}</textarea>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group" style="grid-column: span 4;">
                    <label class="form-label">Terms & Conditions</label>
                    <textarea name="terms_conditions" class="form-control" rows="4">{{ $invoice->terms_conditions ?? '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
