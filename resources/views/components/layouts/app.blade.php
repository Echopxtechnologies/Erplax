...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            {{-- contact menu kuda sub menu enga ullade --}}
            <div class="nav-item" onclick="toggleSubmenu(this)" style="cursor: pointer;">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="nav-submenu">
                <a href="{{ route('admin.contacts.dummy1') }}" class="nav-item {{ request()->routeIs('admin.contacts.dummy1') ? 'active' : '' }}">Dummy 1</a>
                <a href="{{ route('admin.contacts.dummy2') }}" class="nav-item {{ request()->routeIs('admin.contacts.dummy2') ? 'active' : '' }}">Dummy 2</a>
