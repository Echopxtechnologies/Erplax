...
class LotController extends BaseController
{
    ...
    protected $routePrefix = 'admin.inventory.lots';
    ...
    protected function mapRow($item)
    {
        ...
        return [
            ...
            '_show_url' => route('admin.inventory.lots.show', $item->id),
    ...
    public function show($id)
    {
        ...
        return view('admin.inventory.lots.show', compact('lot', 'stockMovements'));
    }
    ...
    public function expiringSoon(Request $request)
    {
        ...
        return view('admin.inventory.lots.expiring', ['lots' => $lots, 'days' => $days]);
    }
