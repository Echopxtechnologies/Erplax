...
Route::prefix('sales/estimations')->name('sales.estimations.')->group(function () {
    ...
    // Actions
// print
    Route::get('/{estimation}/print', [EstimationsFormController::class, 'print'])->name('print');
...
// print
    ...
    Route::get('/{invoice}/print', [InvoicesFormController::class, 'print'])->name('print');
...
//         Route::get('/{payment}/receipt', [\App\Http\Controllers\Admin\Sales\PaymentReceiptController::class, 'show'])->name('receipt.show');
