    ...
    |--------------------------------------------------------------------------
    |
    | All routes here are prefixed with '/client'
    ...
    */
    ...
    Route::prefix('client')->name('client.')->group(function () {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        | Using EnsureIsClient middleware:
        | - If not logged in → redirect to client login
        | - If logged in as admin → redirect to admin dashboard
        | - If logged in as client → allow access
        */
        Route::middleware([EnsureIsClient::class])->group(function () {
            ...
            // Profile Routes (add your profile controller here)
